    ...
    <div className="flex flex-col min-h-screen w-full bg-white font-sans">
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        <div className="mb-10 text-center space-y-6">
           ...
           <h2 className="text-2xl font-medium text-gray-900">Iniciá sesión</h2>
        </div>
          ...
          <CardContent className="pt-6">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="flex justify-end pt-2">
                 <Button
                   type="submit"
                   className="bg-gray-900 hover:bg-gray-800 text-white rounded-full px-6 h-10 w-auto"
                   disabled={loading}
                 >
      ...
      <div className="w-full max-w-2xl mx-auto p-4 mb-8">
         <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
            ...
            >
               ...
               {helpOpen ? <ChevronUp className="w-5 h-5 text-gray-500" /> : <ChevronDown className="w-5 h-5 text-gray-500" />}
            </button>
            {helpOpen && (
