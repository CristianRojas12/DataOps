...
export function MainLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 text-gray-900 overflow-hidden font-sans">
      {/* Sidebar Navigation */}
      <div className="w-16 md:w-64 border-r border-gray-200 bg-white flex flex-col shrink-0">
         <div className="h-16 flex items-center justify-center md:justify-start md:px-6 border-b border-gray-200 shrink-0">
         ...
         <div className="flex-1 py-6 flex flex-col gap-2 px-3">
            <button
               ...
               className={`flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors ${activeTab === 'resumen' ? 'bg-indigo-500/10 text-indigo-400' : 'text-gray-600 hover:text-gray-900 hover:bg-white/5'}`}
            >
            ...
            <button
               ...
               className={`flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors ${activeTab === 'calendario' ? 'bg-indigo-500/10 text-indigo-400' : 'text-gray-600 hover:text-gray-900 hover:bg-white/5'}`}
            >
            ...
            <button
               ...
               className={`flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors ${activeTab === 'productos' ? 'bg-indigo-500/10 text-indigo-400' : 'text-gray-600 hover:text-gray-900 hover:bg-white/5'}`}
            >
            ...
            <button
               ...
               className={`flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors ${activeTab === 'solicitudes' ? 'bg-indigo-500/10 text-indigo-400' : 'text-gray-600 hover:text-gray-900 hover:bg-white/5'}`}
            >
      ...
      <div className="flex-1 flex flex-col min-w-0">
         ...
         <div className="h-16 flex items-center justify-end px-6 border-b border-gray-200 shrink-0 bg-white gap-4">
            {activeTab === "resumen" && (
              <button
